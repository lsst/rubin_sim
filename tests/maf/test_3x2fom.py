...
class Test3x2(unittest.TestCase):
    ...
    def test_3x2(self):
        ...
        m = maf.metrics.ExgalM5_with_cuts(m5Col=colmap['fiveSigmaDepth'], filterCol=colmap['filter'],
                                          lsstFilter='i', nFilters=nfilters_needed,
        ...
        bg = maf.metricBundles.MetricBundleGroup(bd, conn, outDir=self.outDir, resultsDb=resultsDb)
        bg.runAll()
