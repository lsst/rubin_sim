...
class ApproxCoordTests(unittest.TestCase):
    ...
    def test_degrees(self):
        ...
        alt2, az2 = utils.approx_RaDec2AltAz(
        ...
        ra_back, dec_back = utils.approx_altAz2RaDec(
    ...
    def test_rad(self):
        ...
        alt2, az2 = utils._approx_RaDec2AltAz(
        ...
        # Check that the fast can nearly round-trip
        ra_back, dec_back = utils._approx_altAz2RaDec(
