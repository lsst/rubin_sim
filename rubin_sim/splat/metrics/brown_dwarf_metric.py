__all__ = ("BDParallaxMetric", "hp_sum_volume")
...
def hp_sum_volume(inarray):
    """For a Healpix array, calculate the sum of the volume assuming
    array has units of distance.
    """
