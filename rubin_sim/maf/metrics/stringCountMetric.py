...
class StringCountMetric(BaseMetric):
    ...
    def __init__(
        self, metricName="stringCountMetric", col="filter", percent=False, **kwargs
    ):
        """
        Parameters
        ----------
        ...
        super(StringCountMetric, self).__init__(
            cols, metricName, units=units, metricDtype=object, **kwargs
        )
        self.col = col
