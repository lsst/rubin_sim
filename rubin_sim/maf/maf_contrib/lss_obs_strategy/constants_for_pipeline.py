...
plotColor["NoDither"] = [0.0, 0.0, 0.0]  # black

plotColor["RandomDitherFieldPerVisit"] = [
    0.0,
    0.0,
    255 / 255.0,
]  # blue [255/255., 255/255.,   0.]  # yellow
plotColor["RandomDitherFieldPerNight"] = [255 / 255.0, 0.0, 255 / 255.0]  # magenta
plotColor["RandomDitherPerNight"] = [
    255.0 / 255.0,
    0.0,
    0.0,
]  # [139/255., 0.,0.] # dark red

plotColor["RepulsiveRandomDitherFieldPerVisit"] = [
    255 / 255.0,
    105 / 255.0,
    180 / 255.0,
]  # hot pink
plotColor["RepulsiveRandomDitherFieldPerNight"] = [
    255 / 255.0,
    255 / 255.0,
    0.0,
]  # yellow
plotColor["RepulsiveRandomDitherPerNight"] = [
    147 / 255.0,
    112 / 255.0,
    219 / 255.0,
]  # medium purple
...
plotColor["PentagonDitherPerSeason"] = [
    75 / 255.0,
    0.0,
    130 / 255.0,
...
plotColor["FermatSpiralDitherFieldPerVisit"] = [
    124 / 255.0,
    252 / 255.0,
    0.0,
]  # lawngreen
plotColor["FermatSpiralDitherFieldPerNight"] = [0, 206 / 255.0, 209 / 255.0]  # turqoise
plotColor["FermatSpiralDitherPerNight"] = [
    34 / 255.0,
    139 / 255.0,
    34 / 255.0,
]  # forestgreen

plotColor["SequentialHexDitherFieldPerVisit"] = [
    0 / 255.0,
    255 / 255.0,
    127 / 255.0,
]  # spring green      [0.,0.,255/255.] # blue
plotColor["SequentialHexDitherFieldPerNight"] = [139 / 255.0, 0.0, 0.0]  # dark red
plotColor["SequentialHexDitherPerNight"] = [
    184 / 255.0,
    134 / 255.0,
    11 / 255.0,
]  # dark goldenrod
