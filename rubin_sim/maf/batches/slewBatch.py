...
def slewBasics(colmap=None, runName="opsim", sqlConstraint=None):
    ...
    bundle = mb.MetricBundle(
        metric, slicer, sqlConstraint, metadata=metadata, displayDict=displayDict
    )
...
def slewSpeeds(colmap=None, runName="opsim", sqlConstraint=None):
    ...
    for speed in speeds:
        ...
        displayDict["order"] += 1
        bundle = mb.MetricBundle(
            metric, slicer, sqlConstraint, displayDict=displayDict, metadata=metadata
        )
        bundleList.append(bundle)
...
def slewActivities(colmap=None, runName="opsim", totalSlewN=1, sqlConstraint=None):
    ...
    for slewType in slewTypeDict:
        ...
        displayDict["order"] += 1
        bundle = mb.MetricBundle(
            metric, slicer, sql, displayDict=displayDict, metadata=metadata
        )
        bundleList.append(bundle)
